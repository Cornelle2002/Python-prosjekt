...
def main():
    ...
    d = spenningsRes(punkt, nelem, elem, elementlengder, rot, fim, fisk, ei(nelem, elem, geometri), ei(nelem, elem, geometri))
 
    ja = midtM(d, nlast, last, npunlast, punlast, nelem, elementlengder)
