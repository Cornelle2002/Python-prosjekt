    ...
    for i in range(nelem): # ittererer gjennom antall elementer
        ...
        try:
            if geo_nr == 1:   # geomentri/tverrsnitt 1
                I = i_ror(geo[0][1], geo[0][2]) #Regner ut andre arealmoment, I, for rør-geometriene
            elif geo_nr == 2: # geomentri/tverrsnitt 2
                I = i_ror(geo[1][1], geo[1][2]) 
            elif geo_nr == 3: # geomentri/tverrsnitt 3 
                I = i_ror(geo[2][1], geo[2][2]) # I for 
            elif geo_nr == 4: # geomentri/tverrsnitt 4
                I = i_kvadrat(geo[3][3], geo[3][4], geo[3][6]) #Regner I for kvadrat-tverrsnittet
            elif geo_nr == 5: # geomentri/tverrsnitt 5
                I = i_iprofil(geo[4][3], geo[4][4], geo[4][5], geo[4][6]) #Regner I for I-profilet
        
        except ValueError: #Gir feilmelding dersom ingen av geometriene matcher elementet
    ...
    for i in range(nelem):  # ittererer gjennom antall elementer
        ...
        try:
            if geo_nr == 1:   # geomentri/areal 1
                A = a_ror(geo[0][1], geo[0][2]) #Regner areal, A, for rør-geometriene
                ...
                A = a_kvadrat(geo[3][3], geo[3][4], geo[3][6]) #Regner A for kvadrattverrsnittet
            elif geo_nr == 5: # geomentri/areal 5
                A = a_iprofil(geo[4][3], geo[4][4], geo[4][5], geo[4][6]) #Regner A for i-profilet
            
        except ValueError: #Gir feilmeld dersom ingen av geometrien matcher elementet
            print("Geometri ikke funnet")
